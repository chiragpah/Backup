$(document).ready(function () {
  let h1 = `
    <header>
      <div class="header"> 
      <nav class="navbar navbar-expand-lg navbar-light" id="navbar_size" aria-label="true">
        <div class="container-fluid">
          <a class="navbar-brand nav-link active d-flex pt-4" href="/HTML/Homepage.html">
            ...
            <span class="navbar-toggler-icon" style="color:white;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="26" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/>
          </svg></span>

             </button> 
             <img src="/Asset/bookmecom-high-resolution-logo-transparent.png" alt="logo" id="img" width="30%" height="70%" class="d-inline-block align-text-top">
          </a>
         
            <div style="height: 40px;  color: white;  display: flex; margin-top: 10px; " class="login_btn" >
    ...
    <div class="container-fluid" id="nav2">
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="navbar-brand nav-link highlight active" href="/HTML/movieDetails.html">Movies</a>
          </li>
          <li class="nav-item">
            <a class="navbar-brand nav-link highlight" href="/HTML/event.html">Events</a>
          </li>
          <li class="nav-item">
            <a class="navbar-brand nav-link highlight" href="/HTML/sportDetails.html">Sports</a>
          </li>
        </ul>
        <form class="d-flex">
