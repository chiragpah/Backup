    ...
    MovieService.getMovieDetailsById(id).then((res) => {
        ...
        LocationService.getTheaterDetails()
            .then((response) => {
                ...
                console.log(lid);
                $("body").append(` <div class="container-fluid titlebar">
                <div class="row">
                  <div class="col">
                    <div class="row">
                ...
                $("body").append(`<div class='content theaterlist' style='border:2px solid white; padding:20px;'></div>`)

                for (let t of theater) {
                    console.log(t.ScheduleManagement.time[0]);
                    if (lid == t.LocId) {
                        ...
                        <div class="col-8">
                            <div class="row row-cols-2 row-cols-lg-3">
                                <div class="col-4 col-lg-2">
                                    <a class="time" id="time_one" href="/HTML/Seat.html?time=3.00PM">${t.ScheduleManagement.time[0]}</a>
                                   
                                </div>
                                <div class="col-4 col-lg-2">
                                    <a class="time" id="time_two" href='/HTML/Seat.html?'time= ${t.ScheduleManagement.time[1]}>${t.ScheduleManagement.time[1]}</a>
                                   
                                </div>
                                <div class="col-4 col-lg-2">
                                    <a class="time" id="time_three"  href='/HTML/Seat.html?'time= ${t.ScheduleManagement.time[2]}>${t.ScheduleManagement.time[2]}</a>
