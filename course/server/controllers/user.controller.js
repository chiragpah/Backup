...
const activateUser = (async (req, res, next) => {
    try {
        ...
        console.log(typeof activation_code, activation_code);
...
const forgotPassword = (async (req, res, next) => {
    try {
        console.log("hii this is forgot Password");
...
const updateProfilePicture = (async (req, res, next) => {
    try {
        ...
        const file = req.file;
        console.log("In profile update", file);
        const userId = req.user?._id;
...
module.exports = { socialAuth, registrationUser, createActivationToken, activateUser, loginUser, logOutUser, updateAccessToken, getUserInfo, updateUserInfo, updateUserPassword, updateProfilePicture, getAllUsers, updateUserRole, deleteUser, forgotPassword }