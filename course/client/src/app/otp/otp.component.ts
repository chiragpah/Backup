...
export class OtpComponent implements OnInit {
  ...
  constructor(private otpservice: OtpService, private route: ActivatedRoute, private router: Router, private socketService: SocketService) { }
      ...
      this.route.params.subscribe(params => {
        ...
        this.otpservice.activateUser(access_token, otp).subscribe(response => {
          ...
          Swal.fire({
            ...
            // Proceed with navigation after the timer expires
          ...
          this.socketService.listen('notification').subscribe((data) => {
            ...
            console.log("Received a new notification: " + data.user.message);
          });
          ...
          (error) => {
            ...
            Swal.fire({
              position: "center",
              icon: "error",
              title: "Unauthorized access. Please check your credentials.",
              showConfirmButton: false,
              timer: 1500
            });
          })
